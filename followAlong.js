...
window.FollowAlong = (function () {
  ...
  const STEPS = [
    ...
    },
    {
      ...
      mock: `<div class="at-qs"><div><b>위반사실</b> — 분할 수의계약으로 경쟁 회피</div><div><b>근거</b> 지방계약법 시행령 §25 · <b>근거 페이지 p.4·p.7</b> <span class="muted">(처분요구서 원문 쪽)</span></div><div>🚩 동일 업체 반복</div></div>`
    },
    {
