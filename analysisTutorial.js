...
window.AnalysisTutorial = (function () {
  ...
  const STEPS = [
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-chart-bar"></use></svg> 분석은 두 화면 — 현황 / 착안점 찾기`,
      lead: "검색이 ‘무엇이 있나’를 본다면, 분석은 ‘무엇을 봐야 하나’를 봅니다. 상단 두 버튼으로 화면을 바꿉니다.",
      ex: `<div class="at-row"><span class="at-pill"><svg class="ic" aria-hidden="true"><use href="#ic-clipboard-list"></use></svg> 현황 <i>데이터로 보는 공개 사례</i></span><span class="at-pill on"><svg class="ic" aria-hidden="true"><use href="#ic-search"></use></svg> 착안점 찾기 <i>내 사안으로 선례·착안점</i></span></div>`
    },
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-compass"></use></svg> 현황 — 6하원칙으로 한눈에`,
    ...
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-link"></use></svg> 무엇을 → 어떻게 — 위반유형을 고르면 처분이 따라온다`,
    ...
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-search"></use></svg> 누가·심화 — 기관계열별, 특화 위반유형`,
    ...
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-search"></use></svg> 착안점 찾기 — 정황 한 줄 → 선례`,
    ...
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-compass"></use></svg> 세 갈래 — 막막할 때 · 정했을 때 · 넓힐 때`,
      lead: `검색어가 막막하면 <b><svg class="ic" aria-hidden="true"><use href="#ic-folder"></use></svg> 주제로 찾기</b>(자주 적발된 주제·분류에서 골라 검색), 범위를 정했으면 <b><svg class="ic" aria-hidden="true"><use href="#ic-clipboard-list"></use></svg> 사례로 점검하기</b>(선례 착안점을 점검표로 — 체크하면 메모·내 사례함으로), 시야를 넓히려면 <b><svg class="ic" aria-hidden="true"><use href="#ic-link"></use></svg> 적발 관계망</b>(함께 적발된 주제의 연결을 그래프로 탐색)을 누르세요.`,
      ex: `<div class="at-row"><span class="at-pill"><svg class="ic" aria-hidden="true"><use href="#ic-folder"></use></svg> 주제로 찾기</span><span class="at-pill"><svg class="ic" aria-hidden="true"><use href="#ic-clipboard-list"></use></svg> 사례로 점검하기</span><span class="at-pill"><svg class="ic" aria-hidden="true"><use href="#ic-link"></use></svg> 적발 관계망</span></div><div class="at-mc">고르기 → 점검하기 → 넓히기 — 셋은 같은 위상의 진입로입니다.</div>`
    },
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-search"></use></svg> 반론·검증 — 찾은 착안점을 반대편에서 한 번 더`,
      lead: "착안점 찾기 결과 <b>아래에 3자 시각</b>이 붙습니다. 찾은 결론을 그대로 믿지 않고, 반대 선례·빠진 질문·양정 위치를 점검합니다. <span class=\"muted\">생성이 아니라 데이터 인출 — LLM 0.</span>",
      ex: `<div class="at-row"><span class="at-tag dev"><svg class="ic" aria-hidden="true"><use href="#ic-messages"></use></svg> 다중관점</span><span class="at-tag ask"><svg class="ic" aria-hidden="true"><use href="#ic-help-circle"></use></svg> 되묻기</span><span class="at-tag crit"><svg class="ic" aria-hidden="true"><use href="#ic-square-pen"></use></svg> 비평</span></div>`
    },
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-messages"></use></svg> 다중관점 — 반대 선례로 상대 반론 미리 점검 (악마의 대변인 — 반대편 자처·약점 점검)`,
    ...
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-help-circle"></use></svg> 되묻기 — 적신호를 점검 질문으로`,
    ...
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-square-pen"></use></svg> 비평 — 양정 위치·동반 누락`,
    ...
    {
      t: `<svg class="ic" aria-hidden="true"><use href="#ic-shield"></use></svg> 한계도 함께 — 그래서 믿을 수 있게`,
  ...
  function render() {
    ...
    body.innerHTML = `
      <div class="at-head">
        <div class="at-brand"><svg class="ic" aria-hidden="true"><use href="#ic-book-open"></use></svg> 분석·반론검증 사용법 <span class="at-sub">예시로 각 기능을 따라보며 봅니다 · 실제 작업엔 영향 없음 · LLM 호출 0</span></div>
