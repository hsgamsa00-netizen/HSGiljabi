  ...
  function open(opts) {
    ...
    ov.innerHTML = `
      <div class="oi-modal" role="dialog" aria-label="시작 안내">
        <div class="oi-head">
          <div class="oi-brand"><svg class="ic" aria-hidden="true"><use href="#ic-book"></use></svg> 화성 자체감사 길잡이</div>
        ...
        <div class="oi-pipe">
          <div class="oi-stage" style="--d:0s"><div class="oi-badge">STEP 1</div><div class="oi-icon"><svg class="ic" aria-hidden="true"><use href="#ic-help-circle"></use></svg></div><div class="oi-label">현장의 의문</div>
          ...
          <div class="oi-stage" style="--d:.5s"><div class="oi-badge">STEP 2 · <svg class="ic" aria-hidden="true"><use href="#ic-chart-bar"></use></svg> 분석</div><div class="oi-icon"><svg class="ic" aria-hidden="true"><use href="#ic-scale"></use></svg></div><div class="oi-label">분포로 감 잡기</div>
          ...
          <div class="oi-stage" style="--d:1s"><div class="oi-badge">STEP 3 · <svg class="ic" aria-hidden="true"><use href="#ic-folder"></use></svg> 탐색</div><div class="oi-icon"><svg class="ic" aria-hidden="true"><use href="#ic-search"></use></svg></div><div class="oi-label">유사 선례 확인</div>
          ...
          <div class="oi-stage" style="--d:1.5s"><div class="oi-badge">STEP 4</div><div class="oi-icon"><svg class="ic" aria-hidden="true"><use href="#ic-map-pin"></use></svg></div><div class="oi-label">근거 확보</div>
        ...
        <div class="oi-companion"><svg class="ic" aria-hidden="true"><use href="#ic-book"></use></svg> <b>감사 길잡이</b>는 감사계획 수립·현장 점검·양정 판단·처분요구서 작성까지, <b>막막한 출발점을 실제 선례와 근거</b>로 채워 줍니다.<span class="oi-mission">여러 해에 걸쳐 공개된 화성시 자체감사 기록을 한자리에 모아 검색·비교할 수 있게 정리한 자료입니다.</span></div>
        <div class="trust">
          <div class="trust-mark"><span class="hs-bi-wrap"><img class="hs-bi" src="hs_bi.png" alt="화성특례시" /></span></div>
          <svg class="ic" aria-hidden="true"><use href="#ic-shield"></use></svg> <b>본 자료는 화성시가 공개한 자체감사 자료를 바탕으로 제작되었습니다.</b> · 100% 로컬 처리 · 외부 전송 없음<br><span style="font-size:12.5px;color:#5a6b7d">화성시 자체감사 공개자료 · 원문은 <b>화성시 감사 자료</b>에서 확인</span></div>
        <div class="oi-by"><svg class="ic" aria-hidden="true"><use href="#ic-landmark"></use></svg> <b>화성특례시 감사관</b> 제작</div>
        <div class="oi-cta"><button class="oi-skip" data-oi="skip" type="button">건너뛰기</button><button class="oi-start" data-oi="follow" type="button"><svg class="ic" aria-hidden="true"><use href="#ic-pencil"></use></svg> 사례로 따라 하기 →</button></div>
