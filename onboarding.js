  ...
  function open(opts) {
    ...
    ov.innerHTML = `
      <div class="oi-modal" role="dialog" aria-label="시작 안내">
        ...
        <div class="oi-companion">📚 <b>감사 길잡이</b>는 감사계획 수립·현장 점검·양정 판단·처분요구서 작성까지, <b>막막한 출발점을 실제 선례와 근거</b>로 채워 줍니다.<span class="oi-mission">여러 해에 걸쳐 공개된 화성시 자체감사 기록을 한자리에 모아, 찾아보고 비교할 수 있게 정리한 자료입니다. 정리·연결은 자동화가 맡고, <b>판단과 결정은 감사 담당자</b>의 몫입니다.</span></div>
        <div class="trust">
